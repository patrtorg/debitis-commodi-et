...
[![npm version](https://badge.fury.io/js/@patrtorg/debitis-commodi-et.svg)](https://www.npmjs.com/package/@patrtorg/debitis-commodi-et)
...
```shell
npm install @patrtorg/debitis-commodi-et
```
...
import UnifyEmitter from "@patrtorg/debitis-commodi-et";
...
```typescript
import UnifyEmitter, { EventsObject } from "@patrtorg/debitis-commodi-et";
...
Contributions are welcome! If you find any issues or have suggestions for improvements, feel free to open an issue or submit a pull request in the [GitHub repository](https://github.com/patrtorg/debitis-commodi-et).
